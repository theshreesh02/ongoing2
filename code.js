...
let modeBtn = document.getElementById("mode1")
let currMode = "light"
// let bg = getElementById("video")
modeBtn.addEventListener("click",()=>{
  if(currMode=="light"){
    ...
    document.getElementById("mode1").innerHTML = '<img src="black.png" alt="Dark Mode" id="power"> Dark Mode';
    document.getElementById("bro").innerHTML = `
  <video autoplay muted loop id="video">
    <source src="sun1.mp4" type="video/mp4">
    <source src="sun1.webm" type="video/webm">
    ...
    document.getElementById("mode1").innerHTML = '<img src="white.png" alt="Light Mode" id="power"> Light Mode';
    document.getElementById("bro").innerHTML = `
  <video autoplay muted loop id="video">
    <source src="rain1.mp4" type="video/mp4">
    <source src="rain1.webm" type="video/webm">
    Your browser does not support the video tag.
  </video>`;
  }
});
